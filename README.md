...
- A slimmed down version for webpage integration is provided [here](https://tjards.github.io/web_shepherd/?mode=slim).
...
- Thank you to [OldCrow](https://github.com/OldCrow) for the significant improvements in efficiency documented [here](docs/OPTIMIZATION.md).